...
function ifIE() {
  ...
  var is_ie =
    ua.indexOf("MSIE ") > -1 || ua.indexOf("Trident/") > -1 || /Edge/.test(ua);
  return is_ie;
}
...
$form = {
  ...
  label: function (t) {
    var v = t.val();
    v != null && v != ""
      ? t.parents("fieldset").addClass("act")
      : t.parents("fieldset").removeClass("act");
  },
  focus: function () {
    var t = this;
  ...
  pattern: function () {
    ...
    $('input[data-pattern="cb"]').on({
      ...
      focusout: function () {
        ...
        $t.val($v.replace(/ /g, ""));
        $t.val(
          $v.replace(/(\d{4})(\d{4})(\d{4})(\d{4})(\d{2})/g, "$1 $2 $3 $4 $5")
        );
      },
    });
  },
      ...
      var e =
        (_createClass(t, [
              ...
              return (
                ...
                (this.plane_material = new THREE.ShaderMaterial({
                  vertexShader: document.getElementById(
                    "shader-vertex-terrain-perlinsombrero"
                  ).textContent,
                  fragmentShader: document.getElementById(
                    "shader-fragment-terrain"
                  ).textContent,
                ...
                (this.plane_mesh = THREE.SceneUtils.createMultiMaterialObject(
                  this.plane_geometry,
                  this.materials
                )),
          ...
          },
          {
            key: "update",
            value: function () {
              return (this.plane_material.uniforms.time.value =
