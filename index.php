...
<html lang="en">
	<head>
	    ...
	    <title>GraphLinq Analytics • Link with Blockchain activity and off-chains applications.</title>
	...
	<body>
		...
		<script src="./template/js/vendor.js?v=3"></script>
		<script src="./template/js/app.js?v=<?php echo time(); ?>"></script>
    </body>
</html>
